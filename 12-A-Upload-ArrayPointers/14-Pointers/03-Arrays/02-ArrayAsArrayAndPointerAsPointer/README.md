...
## Code
### [ArrayAsArrayAndPointerAsPointer.c](./01-Code/ArrayAsArrayAndPointerAsPointer.c)
```c
#include <stdio.h>
...
int main(void)
{
    ...
    printf("\n\n");
    printf("### Using Array Name as a Array i.e. Value of xth element of iArray : iArray[x] And address of the xth element o iarray : iArray[x] ###\n\n");
    ...
    printf("\n\n");
    printf("### Using pointer as ponter i.e. value of xth element of iArray : *(ptr_iArray + x) And address of the xth element of iArray : (ptr_iArray + x) ###\n\n");
