# ColumnMemoryAllocation_Two

Submitted by Yash Pravin Pawar (RTR2024-023)

## Output Screenshots
![01output.png](./02-Screenshots/01output.png)
![02output.png](./02-Screenshots/02output.png)
![03output.png](./02-Screenshots/03output.png)

## Code
### [ColumnMemoryAllocation_Two.c](./01-Code/ColumnMemoryAllocation_Two.c)
```c
#include <stdio.h>
#include <stdlib.h>
